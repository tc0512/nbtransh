...
### Windows PowerShell
```powershell
curl -O https://github.com/tc0512/nbtransh/releases/download/v0.8.0/install_for_windows.ps1
...
### Linux
```bash
curl -fsSL https://github.com/tc0512/nbtransh/releases/download/v0.8.0/install_for_linux.sh | bash
```
### MacOs
```zsh
curl -O https://github.com/tc0512/nbtransh/releases/download/v0.8.0/install_for_MacOs.sh
./install_for_MacOs.sh
```
### Termux on Android
```bash
curl -fsSL https://github.com/tc0512/nbtransh/releases/download/v0.8.0/install_for_termux_on_android.sh | bash
```
